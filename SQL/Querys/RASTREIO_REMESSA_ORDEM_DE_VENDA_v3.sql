SELECT DISTINCT
    ...
    B.transaction_type_name                     "2-KMB_TRANSAÇÃO",
    B.transaction_quantity                      "2-KMB_QTD_TRANSACIONADA",
    B.subinventory_code                         "2-KMB_SUBINVENTARIO",
    B.organization_code                         "2-KMB_ORG_TRANSAÇÃO",
    to_char(B.creation_date, 'dd/mm/yy hh:mm')  "2-KMB_DATA_TRANSAÇÃO",
    C.segment1                                  "3-KMB_ITEM_TRANSACIONADO",    
    C.transaction_type_name                     "3-KMB_TRANSAÇÃO",
    C.transaction_quantity                      "3-KMB_QTD_TRANSACIONADA",
    C.subinventory_code                         "3-KMB_SUBINVENTARIO",
    C.organization_code                         "3-KMB_ORG_TRANSAÇÃO",
    to_char(C.creation_date, 'dd/mm/yy hh:mm')  "3-KMB_DATA_TRANSAÇÃO",
    ...
    E.transaction_type_name                     "7-KMB_TRANSAÇÃO",
    E.SOMA_QUANTIDADE_SAÍDA                     "7-KMB_SOMA_QTD_SAÍDA",
    E.subinventory_code                         "7-KMB_SUBINVENTARIO",
    E.organization_code                         "7-KMB_KMB_ORG_TRANSAÇÃO",
    F.segment1                                  "8-KMB_ITEM_TRANSACIONADO",
    F.transaction_type_name                     "8-KMB_TRANSAÇÃO",
    F.soma_quantidade_entrada                   "8-KMB_SOMA_QTD_ENTRADA",
    F.subinventory_code                         "8-KMB_SUBINVENTARIO",
    F.organization_code                         "8-KMB_KMB_ORG_TRANSAÇÃO",
    G.operation_id                              "5-KCA_RI",
    G.invoice_num                               "5-KCA_NUM_REMESSA",
    G.segment1                                  "5-KCA_ITEM_TRANSACIONADO", 
    G.transaction_type_name                     "5-KCA_TRANSAÇÃO",
    G.transaction_quantity                      "5-KCA_QTD_TRANSACIONADA",
    G.subinventory_code                         "5-KCA_SUBINVENTÁRIO",
    G.organization_code                         "5-KCA_ORG_TRANSAÇÃO",
    to_char(G.creation_date, 'dd/mm/yy hh:mm')  "5-KCA_DATA_TRANSAÇÃO",
