...
WHERE
    ...
    AND mtt.transaction_type_id = 144)  G       ON  F.TRX_NUMBER = G.INVOICE_NUM
...
GROUP BY
    ...
    mttp.transaction_type_name,
    mtt.subinventory_code,
    cftrc.invoice_line_id)  H   ON  G.invoice_line_id = H.invoice_line_id*/

WHERE /*A.source_line_id IN ( 1221705, 1221706, 1221707, 1221708, 1221709,
                        1221710, 1221711, 1221699, 1221700, 1221701,
                        1221702, 1221703, 1221704)*/
 A.ORDER_TYPE_ID = 1356
AND A.CREATION_DATE BETWEEN '23/11/2022' AND '24/11/2022'
